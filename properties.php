  ...
  <div class="section properties">
    ...
    <div class="row">
      ...
      <div class="col-lg-4">
        ...
        <div class="col-lg-4">
            <button type="button" class="btn btn-primary" style="width: 100%; margin-top:20px; background-color: #36389b; border:none;"  onclick="filterProperties()">Filtriraj</button>
        </div>
        </div>
        </div>
        <div class="container">
